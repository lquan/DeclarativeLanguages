...
verbind_dubbel(Bord,[Eiland1|Rest],Map,Acc) :-
	eland_quota(Bord, Eiland1, Vrij1),
	Vrij1 > 0 -> (
...
eiland_brug_buren(Bord, Eilanden, Map) :-
	zoek_eilanden(Bord,Eilanden),
	findall(Eiland-(0,BurenLijst,[]), 
		(member(Eiland,Eilanden),eiland_brug_buren(Eiland,Eilanden,BurenLijst)), 		Lijst),
...
bord([  (1,1,eiland(4)),  (1,2,_), (1,3,eiland(4)),
	(2,1,_), 	  (2,2,_), (2,3,_), 
	(3,1,eiland(4)),  (3,2,_), (3,3,eiland(4)) 
	]).		  
