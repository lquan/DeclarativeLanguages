...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
verbind(Bord,Map, (R,K1,eiland(Q1)),Breedte,(R,K2,eiland(Q2)),MapOut) :-
	eiland_quota(Bord,(R,K1,eiland(Q1)),Vrij1), 
	eiland_quota(Bord,(R,K2,eiland(Q2)),Vrij2),
	%(Breedte is 2; Breedte is 1),
...
verbind(Bord,Map, (R1,K,eiland(Q1)),Breedte, (R2,K,eiland(Q2)), MapOut) :-
...
losop_eiland(Bord, Eiland1, Map, Onopgelost, MapOut) :-
	...
	((RestQuota > 0) ->
		...
		Eiland1 @< BuurEiland1,
		%member(Breedte1,[2,1]),member(Breedte2,[2,1]),
		verbind(Bord,Map,Eiland1,Breedte1,BuurEiland1,Map1),	
		%eiland_quota(Bord, Eiland1, RestQuota1)
		losop_eiland(Bord, Eiland1, Map1, Onopgelost, _)
		
		%((RestQuota1 > 0) ->
		%	%if then
		%	(member(BuurEiland2,BurenLijst1), 
		%	memberchk(BuurEiland2,Onopgelost),
		%	BuurEiland1 @< BuurEiland2,
		%	
		%	verbind(Bord,Map1,Eiland1,BuurEiland2,Map2),
		%	eiland_quota(Bord, Eiland1, 0),
		%	losop_eiland(Bord, BuurEiland1, Map1, Onopgelost1, Map2)
		%	); %else RestQuota1 =:=0
		%	(
		%	losop_eiland(Bord, BuurEiland1, Map1, Onopgelost1, Map1)
		%	)	
